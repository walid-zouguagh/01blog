...
public class User implements UserDetails {
    ...
    public String getUsername() {
        return this.email; // You login with email → return email
    }
...
// @NoArgsConstructor
// @Builder
// public class User implements UserDetails { // ← THIS IS THE KEY!
...
// @Column(name = "password", nullable = false, length = 255) // ← 255 for
// BCrypt
// private String password;
...
// // @Override
// // public String getUsername() {
// // return this.email; // You login with email
// // }
