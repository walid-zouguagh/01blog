...
public interface NotificationRepository extends JpaRepository<Notification, UUID> {
    ...
    @Query(value = """
            SELECT COUNT(*) FROM notifications WHERE is_read = false AND related_user_id = :userId
            """, nativeQuery = true)
    ...
    @Transactional
    @Query(value = """
            UPDATE notifications SET is_read = true WHERE id = :notifId
            """, nativeQuery = true)
    ...
    @Transactional
    @Query(value = """
            UPDATE notifications SET is_read = true WHERE related_user_id = :userId
            """, nativeQuery = true)
